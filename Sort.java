...
public class Sort {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ìàññèâ çàäàí ðàíäîìíî:");
		Sorts(Array);

		System.out.println("----------------------------");
		System.out.println("Ìàññèâ ïî âîçâðàñòàíèþ:");
		Sorts(Array);

		System.out.println("----------------------------");
		System.out.println("Ìàññèâ ïî óáûâàíèþ:");
		reverseArray(Array);
	...
	static void Sorts(int[] Array) {
		System.out.println("Ïóçûðüêîì:");
		bubbleSort(Array);
		result();

		System.out.println();

		System.out.println("Âñòàâêà:");
		insertSort(Array);
		result();

		System.out.println();

		System.out.println("Âûáîð:");
		choiceSort(Array);
		result();

		System.out.println();

		System.out.println("Åñòåñòâåííîå äâóõïóòåâîå ñëèÿíèå:");
		mergeSort(Array, Array.length);
		result();

		System.out.println();

		System.out.println("Áûñòðàÿ ñîðòèðîâêà:");
		quickSort(Array);
		result();
	...
	static private void result() {
		System.out.println("Âðåìÿ â ìèëëèñåêóíäàõ: " + time);
		System.out.println("Êîëè÷åñòâî ñðàâíåíèé: " + compare);
		System.out.println("Êîëè÷åñòâî îáìåíîâ: " + swap);
	}
